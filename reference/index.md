...
- [`chapter_confirm_send()`](https://rladies.github.io/jinx/reference/chapter_confirm_send.md)
  : Confirm a completed onboarding to the chapter organisers
- [`chapter_meetup_request()`](https://rladies.github.io/jinx/reference/chapter_meetup_request.md)
  : Post the Meetup setup brief on an onboarding issue
- [`chapter_meetup_brief()`](https://rladies.github.io/jinx/reference/chapter_meetup_brief.md)
  : Render the Meetup setup brief for a chapter
- [`chapter_meetup_name()`](https://rladies.github.io/jinx/reference/chapter_meetup_name.md)
  : The Meetup group name for a chapter
- [`chapter_meetup_urlname()`](https://rladies.github.io/jinx/reference/chapter_meetup_urlname.md)
...
- [`chapter_duplicate_comment()`](https://rladies.github.io/jinx/reference/chapter_duplicate_comment.md)
...
- [`chapter_onboard_blocker()`](https://rladies.github.io/jinx/reference/chapter_onboard_blocker.md)
  : Which team is holding a chapter onboarding up
- [`chapter_onboard_summary()`](https://rladies.github.io/jinx/reference/chapter_onboard_summary.md)
  : Summarise an onboarding checklist as markdown
- [`chapter_status_report()`](https://rladies.github.io/jinx/reference/chapter_status_report.md)
  : Report the state of a chapter onboarding
- [`chapter_find_issue()`](https://rladies.github.io/jinx/reference/chapter_find_issue.md)
  : Find the open onboarding issue for a chapter
- [`chapter_remind_stale()`](https://rladies.github.io/jinx/reference/chapter_remind_stale.md)
  : Nudge the team holding up a stale chapter onboarding
- [`chapter_onboard_website()`](https://rladies.github.io/jinx/reference/chapter_onboard_website.md)
...
- [`airtable_base_allowed()`](https://rladies.github.io/jinx/reference/airtable_base_allowed.md)
  : Check whether an Airtable base is within the configured token's
  scope
...
- [`slack_api_call()`](https://rladies.github.io/jinx/reference/slack_api_call.md)
  ...
  handlers that need more than
  [`slack_post_message()`](https://rladies.github.io/jinx/reference/slack_post_message.md)'s
  single `chat.postMessage` call - DM opening, channel lookup,
  bookmarks, and so on. Retries on a 429 or 5xx response, honouring the
  `Retry-After` header up to 60s. Slack's `Retry-After` for a Tier 2
  method is routinely 30-60s, so a shorter cap guarantees failure under
  sustained rate limiting - which a bulk pass over a workspace's
  channels hits readily.
...
- [`slack_channel_index()`](https://rladies.github.io/jinx/reference/slack_channel_index.md)
  : Index a workspace's public channels

- [`slack_channel_mention()`](https://rladies.github.io/jinx/reference/slack_channel_mention.md)
  :

  Resolve a channel name to a Slack `<#id|name>` mention

- [`slack_conversations_open()`](https://rladies.github.io/jinx/reference/slack_conversations_open.md)
...
- [`slack_invite_approval_checklist_blocks()`](https://rladies.github.io/jinx/reference/slack_invite_approval_checklist_blocks.md)
...
- [`slack_invite_request_blocks()`](https://rladies.github.io/jinx/reference/slack_invite_request_blocks.md)
...
Reviewed topic, description and name changes for public channels

- [`channel_copy_proposals()`](https://rladies.github.io/jinx/reference/channel_copy_proposals.md)
  : Read the reviewed channel copy proposals
- [`channel_rename_proposals()`](https://rladies.github.io/jinx/reference/channel_rename_proposals.md)
...
R-side handling of the slack-event repository_dispatch contract
...
Welcome DMs for newly joined Slack members
...
Cloudflare Workers status and cache-purge tooling

- [`cf_ops_format_workers_report()`](https://rladies.github.io/jinx/reference/cf_ops_format_workers_report.md)
...
- [`cf_ops_list_workers_scripts()`](https://rladies.github.io/jinx/reference/cf_ops_list_workers_scripts.md)
...
- [`cf_ops_workers_invocations()`](https://rladies.github.io/jinx/reference/cf_ops_workers_invocations.md)
...
- [`reaction_direction()`](https://rladies.github.io/jinx/reference/reaction_direction.md)
...
Weekly community channel spotlight posted to Slack

- [`channel_promo_post()`](https://rladies.github.io/jinx/reference/channel_promo_post.md)
  : Build and post the weekly channel spotlight to the community
  workspace
...
- [`r_challenge_draft_post()`](https://rladies.github.io/jinx/reference/r_challenge_draft_post.md)
