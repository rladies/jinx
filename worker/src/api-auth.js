...
// The bearer key gating the worker's HTTP API. Named for what it opens: the
// jinx worker's API. `JINX_API_KEY` read as "some key belonging to jinx", of
// which there are several.
export function worker_api_key(env) {
  return env.JINX_WORKER_API_KEY;
}
